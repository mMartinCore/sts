...
$classes = ($active ?? false)
    ...
    : ' block pl-3 pr-4 py-2 border-l-4 border-r-4 border-transparent  font-extrabold text-gray-900 rounded-2xl
        hover:text-gray-700 hover:bg-blue-50 hover:border-blue-900 focus:outline-none focus:text-gray-800 focus:bg-gray-50
