...
<svg class="bg-green-400" viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg- gray-100 overflow-hidden   sm:rounded-lg">
                <div class="   font-serif text-gray-700 p-4 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                        <h1 class="my-4 xs:text-4xl sm:text-4xl  font-bold leading-tight ">Sign up once and do unlimited shipping</h1>
                   ...
                   <div class="px-4 mt-8 mb-8 ">
                     <a href="https://sts.shiptojm.com/Account/Register" class="mx-auto   lg:mx-0 hover:underline bg-green-400 text-green-100 font-bold rounded-full my-6 py-4 px-8 shadow-2xl hover:bg-blue-400">GET STARTED</a>
                  </div>
        ...
        <svg class="wave-top w-full bg-blue-400" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
