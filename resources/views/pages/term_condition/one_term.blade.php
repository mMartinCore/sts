...
<div class="definitions">
    <h2 class="text-2xl text-gray-700 mb-4">Definitions</h2>
    <ul class="list-none pl-0 space-y-2">
        <li><strong>Branch-</strong> Collection point or outpost operated by the company, it may be virtually automated lockers or physical store locations</li>
        <li><strong>Shipments (packages) –</strong> represent the actual items or orders fulfilled and delivered to our location overseas</li>
        <li><strong>Content:</strong> information, graphics, animations, products, features, functionality, services, and links on shiptosureja.com</li>
        <li><strong>Shiptosureja:</strong> Ship to Sure Holdings Limited, Ipack Freight Logistics LLC, its parent, subsidiary, and/ or any affiliated companies.</li>
        <li><strong>You:</strong> Yourself and/ or the entity that you represent</li>
        <li><strong>User:</strong> any user of our service(s)</li>
        <li><strong>Hub to Hub ® -</strong> The Company's inter-island branch to-branch service</li>
        <li><strong>Account number: -</strong> This unique number is provided by our system to identify all incoming cargo shipped to your address for example STS557XX</li>
    </ul>
</div>

<div class="use-of-services mt-8">
    <h2 class="text-2xl text-gray-700 mb-4">Use of SHIPTOSUREJA Services</h2>
    
    <div class="mb-6">
        <h3 class="text-xl text-gray-700 mb-2">1. Ownership</h3>
        <p>
            All content, data, information, and materials, presented and displayed on our Website ("Content"), including any intellectual property rights in such Content (including without limitation) wording, graphical images, motion pictures, sound events, software code in various languages, or other intellectual property rights associated with our website, social media accounts on all platforms, are owned and is the property of SHIP TO SURE limited, its licensors, and is protected by applicable laws regarding intellectual property. Users of the Website must assume that all content is protected by intellectual property rights, and therefore written consent from SHIP TO SURE HOLDINGS Ltd is required before any part thereof can be used.
        </p>
    </div>

    <div class="mb-6">
        <h3 class="text-xl text-gray-700 mb-2">Authorized and Prohibited Uses</h3>
        <p>
    ...
    <div class="mb-6">
        <h3 class="text-xl text-gray-700 mb-2">1. Registration and Passwords</h3>
        <p>
...
<div class="cyber-security mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Cyber Security</h2>
    <p class="mb-4">
        Shiptosureja may discontinue, suspend or modify Shiptosureja.com at any time without notice, and shiptosureja may block, terminate or suspend a user's access to shiptosureja.com at any time for any reason in its sole discretion, even if access continues to be allowed to others.
    </p>
    <ol class="list-decimal pl-5">
        <li>
            The use of non-authorized scripting technologies to obtain information from shiptosureja or submit information through shiptosureja.com is strictly prohibited. Any attempt to hack or cause disruption to the information technology infrastructure can lead to legal action or fines in your local jurisdiction. The company will cooperate at all times with relevant authorities against cyber-attacks of any nature. Shiptosureja.com and its virtual content may be changed, deleted, or updated at any time without notice as the company pleases.
        </li>
    </ol>
</div>

<div class="identification mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Identification</h2>
    <p>
...
<div class="invoicing-valuation mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Invoicing & Valuation</h2>
    <p>
...
<div class="inbound-charge mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Inbound Charge</h2>
    <p>
        Inbound fees or Inbound charges comprise several costs used to simplify our service offering to our customers and to make shipping a less complex process. These costs are but not limited to airline fuel charges, overseas storage fees where applicable, logistical deliveries, Insurance, and overseas processing and handling, Stripping fees, Wharfage fees and demurrage charges
    </p>
</div>

<div class="promotions-giveaways mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Promotions and Giveaways</h2>
    <p class="mb-4">
        The company or its subsidiaries, or contracted agents, may at any time alter, edit, or change any clause relating to promotional giveaways or company promotional offerings at any time. The company reserves the right to cancel or to alter any condition pertaining to any promotion without notice to the user regardless of the reasons or discretions that lead to any such consideration by the board or other management bodies within the company, to change, edit or remove any such clause.
    </p>
    <p class="mb-4">
        We, the company, its agents, and subsidiaries are indemnified from the user's actions to click, any unauthorised website link(s), or engage in promotions not authorised or published by the company, by way of phishing emails, text messages, and, other such cyber attacks and scams, or brand impersonation by a malicious third party, group or agents.
    </p>
    <p>
        Users have the option of ensuring to confirm, by way of support tickets, by calling the company's published numbers, or by downloading our official play store and app store apps, via only our authorised and publicly verifiable channels (verified social media accounts on Tik Tok, Instagram, Twitter, or Facebook, etc any such promotion or giveaway.
    </p>
</div>

<div class="customer-ethics-behaviour mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Customer Ethics & Behaviour</h2>
    <p class="mb-4">
        For any reason, whether in-store, during deliveries to end-users, or through audio-based or web-based chat communication channels a customer becomes abusive verbally or physically (if applicable) the company reserves the right to ask the customer to desist the violent or abusive behavior, if they fail to comply our security agents and third parties will be asked to respond to remove the violent or threatening customer from our premises.
    </p>
    <p class="mb-4">
        As a user of our services, you agree to be recorded by our CC-TV and security systems to ensure a safe environment for all customers and staff, in addition, all means of communication are monitored to ensure the quality of service and adherence to our terms of service. In such cases of threats to staff members, the customer will be formally reported to local law enforcement information and in some cases at the customer's discretion, the company may disable future use of its services for the customers and their third-party authorized pick-ups on their accounts.
    </p>
    <p class="mb-4">
        Please be advised that any appeal to these decisions is solely at the company's discretion. Legal action may be taken, if there is any destruction of company property by a customer or user, of which, all legal fees will need to be covered by the customer if it is found by the courts that they are guilty of the same.
    </p>
    <p>
        Please ensure you understand these terms explicitly and practice in-store behavior accordingly.
    </p>
</div>

<div class="user-data-information mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">User data or information</h2>
...
<div class="privacy-policy mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Privacy Policy</h2>
    <p>
        As per our privacy <a href="https://shiptosureja.com/pages/privacy" class="text-blue-600 hover:underline">www.shiptosureja.com/pages/privacy</a>
    </p>
</div>  
<div class="services mb-8 w-full">
    <p></p>
    <h2 class="text-2xl text-gray-700 mb-4 ">Services</h2> 
    <!-- Content for Services section would go here -->
</div>

<div class="additional-terms mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Additional terms</h2>
    ...
    <div class="mb-4">
        <p>
            Ship to Sure Holdings Limited, its appointed agents, subsidiaries, or affiliates reserves its right not to disclose any such information to our customers or users, commercial or individual, about shipment or package information as it pertains to or is in accordance with our clearance procedures and execution.
        </p>
    </div>
...
<div class="restricted-items mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Restricted Items</h2>
    ...
    <div class="ml-4">
        <p class="font-semibold">For Jamaica</p>
        <a href="https://www.jacustoms.gov.jm/sites/default/files/docs/Restriction Items.pdf" 
...
<div class="additional-info mb-8">
    ...
    <h3 class="text-xl text-gray-700 mb-2">Consignee Information:</h3>
    <p class="mb-4">
        Failure to correctly use your shipping address as illustrated may cause delays in identifying shipments at our overseas location. This will also cause inadequate information to be updated in our system to provide customs officers or agents with, once the shipment reaches its destination country. Please correctly place your FULL NAME (as it appears on government identification cards) and address with account number whenever shipping items or packages to our overseas address.
    </p>

    <h3 class="text-xl text-gray-700 mb-2">China Warehouse Address</h3>
    <p class="mb-4">
        We provide a China Warehouse address to all out clients who are registered on the shiptosureja.com platform. This address can be accessed by requesting it through anyone of our communication medium. When using the China Direct Address please ensure that you speak directly to a representative who will explain full terms and conditions before your goods are delivered. Please ensure that your full name and Shipping Mark MS6073 is written on all packages delivering to the China address. To ensure this is done, communicate this effectively to your supplier in China. The China Warehouse address is given in Chinese and this should be copied and forward to the supplier that you are using in China. If the address is converted to English you do so at your own risk.
    </p>

    <h3 class="text-xl text-gray-700 mb-2">List of restricted items</h3>
    <ol class="list-decimal pl-5 mb-4">
        <li>Checks, money orders, or any other financial instrument</li>
        <li>Credit, debit, or stored value cards regardless of ownership</li>
        <li>Occult Material, as per restrictions in the destination country</li>
        <li>Goods or items obtained under proceeds of a crime or fraudulent activity</li>
    </ol>
    <p class="italic">
        Please note this list is not exhaustive and can include items or paraphilia not listed here
    </p>
</div>
<div class="importation-clearance mb-8">
    <h2 class="text-2xl text-gray-700 mb-4">Importation & Clearance</h2>
    
    <ol class="list-decimal pl-5 mb-4">
        <li class="mb-2">
            Shiptosureja provides importation and clearance services on behalf of its clients, corporation, or individual user. The company offers its services in multiple jurisdictions via multiple warehouse locations.
        </li>
        <li>
            <h3 class="text-xl text-gray-700 mb-2">Types of shipments</h3>
        </li>
    </ol>
